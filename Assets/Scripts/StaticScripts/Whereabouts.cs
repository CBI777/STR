/// <summary>
/// This class is a public static class that defines whereabouts of needed resources.
/// coders can use this class when they are using 'Resources.load', instead of hard-coding every single path.
/// </summary>
public static class Whereabouts
{
    ...
    public static string LineSprite = "Node/NodeLineSprite/LineSprite_";
